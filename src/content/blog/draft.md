...
![Engine Architecture](/first-devlog/Engine-Architecture.png "Engine Architecture")

the picture above [Engine Architecture](/first-devlog/Engine-Architecture.png), is the high-level architecure of the engine, it is divided in
...
<video controls>
  <source src="/first-devlog/Demo.mp4" type="video/mp4">
